...
name: Contoso Chat - Retail RAG Copilot with Azure AI Studio and Prompty (Python Implementation) - documents are autogenerated for Mintlify via OpenAI GPT-5-nano
